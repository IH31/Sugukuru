...
<jsp:include page="../template/template.jsp">
  <jsp:param value="法人顧客情報｜すぐくる管理システム" name="siteTitle" />
  ...
  <jsp:param name="pageContents">
  	<jsp:attribute name="value">
		  ...
		  <p class="text-center"><a href="${pageContext.request.contextPath}/admin/customer" class="btn btn-primary">Back</a></p>
		</div>
  	</jsp:attribute>
  </jsp:param>
</jsp:include>